module.exports = {
  ...
  theme: {
    ...
    fontFamily: {
      Arimo: ['Arimo', 'Helvetica', 'Arial', 'serif'],
      BaiJamjuree: ['"Bai Jamjuree"', 'Helvetica', 'Arial', 'serif'],
      IstokWeb: ['"Istok Web"', 'Helvetica', 'Arial', 'serif'],
      JockeyOne: ['"Jockey One"', 'Helvetica', 'Arial', 'serif'],
      Inter: ['Inter', 'Helvetica', 'Arial', 'serif'],
      Montserrat: ['Montserrat', 'Helvetica', 'Arial', 'serif'],
      InstrumentSans: ['"Instrument Sans"', 'Helvetica', 'Arial', 'serif'],
    },
  },
